...
DECLARE_TASK(2) {
    ...
    my_puts("\nWITH MUTEX:\n");
    my_puts("  Counter: ");
    char b1[20]; int idx = 0;
    if (fp == 0) { b1[idx++] = '0'; } else {
        int v = fp, d = 0; while (v > 0) { v /= 10; d++; }
        for (int j = d - 1; j >= 0; j--) { b1[j] = '0' + (fp % 10); fp /= 10; } idx = d;
    }
    b1[idx++] = '\n'; b1[idx] = '\0'; my_puts(b1);
    
    my_puts("  Complex: ");
    char b2[20]; idx = 0;
    if (fc == 0) { b2[idx++] = '0'; } else {
        int v = fc, d = 0; while (v > 0) { v /= 10; d++; }
        for (int j = d - 1; j >= 0; j--) { b2[j] = '0' + (fc % 10); fc /= 10; } idx = d;
    }
    b2[idx++] = '\n'; b2[idx] = '\0'; my_puts(b2);
    ...
    my_puts("  Counter: ");
    char b3[20]; idx = 0;
    if (fu == 0) { b3[idx++] = '0'; } else {
        int v = fu, d = 0; while (v > 0) { v /= 10; d++; }
        for (int j = d - 1; j >= 0; j--) { b3[j] = '0' + (fu % 10); fu /= 10; } idx = d;
    }
    b3[idx++] = '\n'; b3[idx] = '\0'; my_puts(b3);
    
    my_puts("  Complex: ");
    char b4[20]; idx = 0;
    if (fuc == 0) { b4[idx++] = '0'; } else {
        int v = fuc, d = 0; while (v > 0) { v /= 10; d++; }
        for (int j = d - 1; j >= 0; j--) { b4[j] = '0' + (fuc % 10); fuc /= 10; } idx = d;
    }
    b4[idx++] = '\n'; b4[idx] = '\0'; my_puts(b4);
...
DECLARE_TASK(3) { while (1) { my_puts("Task 3\n"); sys_sleep(1000); } }
DECLARE_TASK(4) { while (1) { my_puts("Task 4\n"); sys_sleep(1000); } }
DECLARE_TASK(5) { while (1) { my_puts("Task 5\n"); sys_sleep(1000); } }
DECLARE_TASK(6) { while (1) { my_puts("Task 6\n"); sys_sleep(1000); } }
DECLARE_TASK(7) { while (1) { my_puts("Task 7\n"); sys_sleep(1000); } }
DECLARE_TASK(8) { while (1) { my_puts("Task 8\n"); sys_sleep(1000); } }
DECLARE_TASK(9) { while (1) { my_puts("Task 9\n"); sys_sleep(1000); } }
DECLARE_TASK(10) { while (1) { my_puts("Task 10\n"); sys_sleep(1000); } }
DECLARE_TASK(11) { while (1) { my_puts("Task 11\n"); sys_sleep(1000); } }
DECLARE_TASK(12) { while (1) { my_puts("Task 12\n"); sys_sleep(1000); } }
DECLARE_TASK(13) { while (1) { my_puts("Task 13\n"); sys_sleep(1000); } }
DECLARE_TASK(14) { while (1) { my_puts("Task 14\n"); sys_sleep(1000); } }
DECLARE_TASK(15) { while (1) { my_puts("Task 15\n"); sys_sleep(1000); } }
DECLARE_TASK(16) { while (1) { my_puts("Task 16\n"); sys_sleep(1000); } }
DECLARE_TASK(17) { while (1) { my_puts("Task 17\n"); sys_sleep(1000); } }
DECLARE_TASK(18) { while (1) { my_puts("Task 18\n"); sys_sleep(1000); } }
DECLARE_TASK(19) { while (1) { my_puts("Task 19\n"); sys_sleep(1000); } }
DECLARE_TASK(20) { while (1) { my_puts("Task 20\n"); sys_sleep(1000); } }
